 ...
 */
public class MessageThreadAdapter extends ArrayAdapter<String> {
    private final Activity context;
    public JSONArray messages;

    public MessageThreadAdapter(Activity context, JSONArray messages) {

        super(context, R.layout.row_message_thread);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (rowView == null)
        {
            ...
            rowView= inflater.inflate(R.layout.row_message_thread, null, true);
